  ...
  template: `
    <section class='side-bar flex column align-center'>
       ...
       <div class="side-bar-btns">
          <router-link to='/email/inbox/list' class='side-links flex align-center'>
             <i class="fa fa-inbox" aria-hidden="true"></i>
             <h2>Inbox</h2>
          </router-link>
          <router-link to='/email/inbox/starred' class='side-links flex align-center'>
             <i class="fa fa-star" style="font-size:25px"></i>
             <h2>Starred</h2>
          </router-link>
          <router-link to='/email/inbox/sent' class='side-links flex align-center'>
             <i class="fa fa-paper-plane" aria-hidden="true"></i>
             <h2>Sent</h2>
          </router-link>
          <router-link to='/email/inbox/draft' class='side-links flex align-center'>
             <i class="fa fa-file" aria-hidden="true"></i>
             <h2>Drafts</h2>
          </router-link>
          <router-link to='/email/inbox/deleted' class='side-links flex align-center'>
